...
Commit Sweeper is background work. It defaults to 4 commits per workflow page
...
`CLAWSWEEPER_COMMIT_REVIEW_PAGE_SIZE` between 1 and 80, then pages large ranges:
