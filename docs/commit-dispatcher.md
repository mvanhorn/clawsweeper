...
Commit review is a background lane. It defaults to 4 commits per workflow page
...
```text
CLAWSWEEPER_COMMIT_REVIEW_PAGE_SIZE=4
```

The receiver clamps this between 1 and 80. Setting the variable bypasses the
